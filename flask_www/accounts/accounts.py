...
@accounts_bp.route('/resetting/<int:_id>', methods=['GET'])
...
def resetting(_id):
    ...
    if profile_obj:
        return render_template('accounts/resetting/account_resetting.html', user=user_obj, profile=profile_obj)
    else:
        return render_template('accounts/resetting/account_resetting.html', user=user_obj)
